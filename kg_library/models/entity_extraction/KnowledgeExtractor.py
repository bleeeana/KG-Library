...
class KnowledgeGraphExtractor:
    ...
    def extract_from_text(self, text : str, num_beams=3, max_length=1024) -> set:
    ...
    def extract_from_full_text(self, text : str):
        preprocessed_text = self.preprocessor.preprocessing(text)
